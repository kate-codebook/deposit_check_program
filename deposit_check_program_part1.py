...
def create_sheet(month, hometax_file, status_file):   #sheet addition to existing excel file
...
def main(): 
  ...
  end_date = end_month(month)

  create_sheet(month, hometax_file, status_file)
